...
@sfxml
class MaleLeanBodyMassPageController(private val weightInput: TextField, private val heightInput: TextField, private val lbmResultLabel:Label, private val fpResultLabel:Label) extends ErrorHandler with ButtonHandler
{
